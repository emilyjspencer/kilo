...
import com.example.kiloexperiment.authkiloexperiment.models.Permission.*;
import com.example.kiloexperiment.authkiloexperiment.models.Role.ACCOUNT_MANAGER;
import com.example.kiloexperiment.authkiloexperiment.models.Role.ADMIN;
import com.example.kiloexperiment.authkiloexperiment.models.Role.CONSULTANT;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf(csrf -> csrf.disable()).authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(GET, "/api/jobs/**").hasAnyAuthority(ADMIN_READ.getPermission(), ACCOUNT_MANAGER_READ.getPermission(), CONSULTANT.getPermission())
